(function(){
    ...
    // === BOBO BEE TEXTURE (baby lamb face) at slot (0, 256*3) ===
    // Normal version
    tex_ctx.translate(0,256*3)
    // Cream/white body background (like gummy bee but white)
    tex_ctx.fillStyle='rgb(245,240,230)'
    tex_ctx.fillRect(0,0,128,128)
    // Fluffy wool texture bumps
    tex_ctx.fillStyle='rgb(255,250,242)'
    for(let i=0;i<8;i++){
        let bx=15+i*14,by=10+Math.sin(i*1.3)*8
        tex_ctx.beginPath();tex_ctx.arc(bx,by,10,0,6.28);tex_ctx.fill()
    }
    for(let i=0;i<7;i++){
        let bx=20+i*14,by=100+Math.sin(i*1.7)*8
        tex_ctx.beginPath();tex_ctx.arc(bx,by,10,0,6.28);tex_ctx.fill()
    }
    tex_ctx.translate(128/2,128/2)
    // Eyes (big cute lamb eyes)
    tex_ctx.fillStyle='rgb(30,30,30)'
    tex_ctx.beginPath();tex_ctx.ellipse(-18,-8,9,11,0,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.ellipse(18,-8,9,11,0,0,6.28);tex_ctx.fill()
    // Eye shine
    tex_ctx.fillStyle='rgb(255,255,255)'
    tex_ctx.beginPath();tex_ctx.arc(-14,-13,4,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.arc(22,-13,4,0,6.28);tex_ctx.fill()
    // Pink nose
    tex_ctx.fillStyle='rgb(255,170,170)'
    tex_ctx.beginPath();tex_ctx.ellipse(0,12,8,6,0,0,6.28);tex_ctx.fill()
    // Nostrils
    tex_ctx.fillStyle='rgb(220,130,130)'
    tex_ctx.beginPath();tex_ctx.arc(-3,13,2,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.arc(3,13,2,0,6.28);tex_ctx.fill()
    // Cute mouth
    tex_ctx.strokeStyle='rgb(180,130,130)'
    tex_ctx.lineWidth=2
    tex_ctx.beginPath();tex_ctx.arc(0,18,6,0.2,2.9);tex_ctx.stroke()
    // Ears (floppy lamb ears)
    tex_ctx.fillStyle='rgb(235,225,210)'
    tex_ctx.beginPath();tex_ctx.ellipse(-40,-5,12,8,-0.3,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.ellipse(40,-5,12,8,0.3,0,6.28);tex_ctx.fill()
    tex_ctx.fillStyle='rgb(255,190,190)'
    tex_ctx.beginPath();tex_ctx.ellipse(-40,-5,7,5,-0.3,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.ellipse(40,-5,7,5,0.3,0,6.28);tex_ctx.fill()
    tex_ctx.translate(-128/2,-128/2)
    // Body stripes (bottom half - cream with slight pink)
    tex_ctx.fillStyle='rgb(255,235,225)'
    tex_ctx.fillRect(0,128,128,128)
    // Fluffy wool on body
    tex_ctx.fillStyle='rgb(245,240,230)'
    tex_ctx.fillRect(0,128,128,128/3|0)
    tex_ctx.fillRect(0,213,128,128/3|0+1)
    tex_ctx.setTransform(1,0,0,1,0,0)
    // Gifted version (at y + 768)
    tex_ctx.translate(0,256*3+768)
    tex_ctx.fillStyle='rgb(255,250,200)'
    tex_ctx.fillRect(0,0,128,128)
    tex_ctx.fillStyle='rgb(255,255,220)'
    for(let i=0;i<8;i++){
        let bx=15+i*14,by=10+Math.sin(i*1.3)*8
        tex_ctx.beginPath();tex_ctx.arc(bx,by,10,0,6.28);tex_ctx.fill()
    }
    ...
    tex_ctx.beginPath();tex_ctx.ellipse(-18,-8,9,11,0,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.ellipse(18,-8,9,11,0,0,6.28);tex_ctx.fill()
    tex_ctx.fillStyle='rgb(255,255,100)'
    tex_ctx.beginPath();tex_ctx.arc(-14,-13,4,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.arc(22,-13,4,0,6.28);tex_ctx.fill()
    tex_ctx.fillStyle='rgb(255,170,170)'
    tex_ctx.beginPath();tex_ctx.ellipse(0,12,8,6,0,0,6.28);tex_ctx.fill()
    ...
    tex_ctx.lineWidth=2
    tex_ctx.beginPath();tex_ctx.arc(0,18,6,0.2,2.9);tex_ctx.stroke()
    tex_ctx.fillStyle='rgb(245,235,180)'
    tex_ctx.beginPath();tex_ctx.ellipse(-40,-5,12,8,-0.3,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.ellipse(40,-5,12,8,0.3,0,6.28);tex_ctx.fill()
    tex_ctx.fillStyle='rgb(255,200,150)'
    tex_ctx.beginPath();tex_ctx.ellipse(-40,-5,7,5,-0.3,0,6.28);tex_ctx.fill()
    tex_ctx.beginPath();tex_ctx.ellipse(40,-5,7,5,0.3,0,6.28);tex_ctx.fill()
    tex_ctx.translate(-128/2,-128/2)
    tex_ctx.fillStyle='rgb(255,245,200)'
    tex_ctx.fillRect(0,128,128,128)
    tex_ctx.fillStyle='rgb(255,250,210)'
    tex_ctx.fillRect(0,128,128,128/3|0)
    tex_ctx.fillRect(0,213,128,128/3|0+1)
    tex_ctx.setTransform(1,0,0,1,0,0)
    // === END BOBO BEE TEXTURE ===
